  ...
  return (
    <>
      ...
      <header className={styles.header}>
        <div className={styles.logo}>TownLogo</div>
        <nav>
          <Link href="/">Home</Link>
      ...
      <main className={styles.container}>
        ...
        <section className={styles.section}>
            ...
            <div className={styles.cardGrid6}>
                {[...Array(6)].map((_, i) => (
                    <Link href="#" className={styles.galleryCard} key={i}>
                        <Image src={`https://placehold.co/300x300.png?text=Town+Image+${i+1}`} alt={`Gallery image ${i+1}`} width={300} height={300} />
