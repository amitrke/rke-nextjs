...
/******/ 	return __webpack_require__(__webpack_require__.s = "4FhY");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_plugin_loader_middleware_on_error_server___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("KqAr");
    ...
    const ComponentInfo = __webpack_require__("aZ4j")
    ...
    async function renderReqToHTML(req, res, renderMode, _renderOpts, _params) {
      ...
      try {
        ...
        let result = await renderToHTML(req, res, "/album", Object.assign({}, getStaticProps ? {} : parsedUrl.query, nowParams ? nowParams : params, _params, isFallback ? { __nextFallback: 'true' } : {}), renderOpts)
...
// CONCATENATED MODULE: ./src/templates/album/Album.js
...
function Album() {
  const classes = useStyles();
  return __jsx(external_react_default.a.Fragment, null, __jsx(CssBaseline_default.a, null), __jsx(Container_default.a, {
    maxWidth: "lg"
  }, __jsx(Header["a" /* default */], {
    title: "Photos",
    sections: sections
  }), __jsx("main", null, __jsx(Container_default.a, {
    className: classes.cardGrid,
    maxWidth: "md"
  }, __jsx(Grid_default.a, {
    container: true,
    spacing: 4
  }, cards.map(card => __jsx(Grid_default.a, {
    item: true,
    key: card,
    xs: 12,
    sm: 6,
    ...
    variant: "h5",
    component: "h2"
  }, "Heading"), __jsx(Typography_default.a, null, "This is a media card. You can use this section to describe the content.")), __jsx(CardActions_default.a, null, __jsx(Button_default.a, {
    size: "small",
    color: "primary"
  }, "View"), __jsx(Button_default.a, {
    size: "small",
    color: "primary"
  }, "Edit"))))))))), __jsx(Footer["a" /* default */], {
    title: "Footer",
...
const Albumpage = props => album_jsx(Album, null);

Albumpage.getInitialProps = async function () {
  return {};
};

/* harmony default export */ var album = __webpack_exports__["default"] = (Albumpage);
